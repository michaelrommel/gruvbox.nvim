...
M.setup = function()
  ...
  local groups = {
    ...
    Substitute = { fg = colors.neutral_red, bg = colors.fg1, reverse = config.inverse },
    ...
    Pmenu = config.transparent_mode and { fg = colors.fg3, bg = nil } or { fg = colors.fg3, bg = colors.bg0 },
    PmenuSel = { fg = colors.bg1, bg = colors.blue, bold = config.bold },
    PmenuSbar = { bg = colors.bg2 },
    PmenuThumb = { bg = colors.bg4 },
    PmenuExtra = { fg = colors.bg3, italic = config.italic.comments },
    DiffDelete = { fg = colors.bg3, bg = "#281818" },
    DiffAdd = { bg = "#102820" },
    DiffChange = { bg = "#212223" },
    ...
    RenderMarkdownCode = { bg = "#202020" },
    RenderMarkdownH1Bg = { bg = colors.bg1, fg = colors.yellow, bold = config.bold },
    RenderMarkdownH2Bg = { bg = colors.bg1, fg = colors.blue, bold = config.bold },
    RenderMarkdownH3Bg = { bg = colors.bg1, fg = colors.purple, bold = config.bold },
    RenderMarkdownH4Bg = { bg = colors.bg1, fg = colors.aqua, bold = config.bold },
    RenderMarkdownH5Bg = { bg = colors.bg1, fg = colors.red, bold = config.bold },
    RenderMarkdownH6Bg = { bg = colors.bg1, fg = colors.green, bold = config.bold },
    ...
    -- @operator              ; symbolic operators (e.g. `+` / `*`)
    ["@operator.special"] = { link = "GruvboxYellow" },
    ...
    -- @export             ; keywords for exporting functions or variables
